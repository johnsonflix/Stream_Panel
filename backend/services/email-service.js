...
async function sendTemplateEmail(options) {
    try {
        ...
        if (userData.id) {
            // First try IPTV Editor playlist
        ...
        const replacements = {
            ...
            '{{iptv_editor_username}}': userData.iptv_editor_username || '',
            '{{iptv_editor_password}}': userData.iptv_editor_password || '',
